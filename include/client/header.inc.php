    ...
    <body>
        <div id="container">
            ...
            <div id="header">
                    ...
                    <p>
                        ...
                        if (
                            ...
                            if ($thisclient && $thisclient->isValid() && $thisclient->isGuest()) { ?>
                                ...
                                <a href="<?php echo $signin_url; ?>" class="naked-link"><img
                                        src="<?php echo ROOT_PATH; ?>assets/default/images/icons/signin.png"
                                        title="<?php echo __('Sign In'); ?>" /></a>
                                <?php
                            }
                        } ?>
                    </p>
                ...
                <a class="pull-left naked-link" id="logo" href="<?php echo ROOT_PATH; ?>index.php"
